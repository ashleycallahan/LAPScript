...
th button[aria-label*="Actual Result"], th button[aria-label*="Recommendation"], th button[aria-label*="Steps to reproduce"] {
    width: 250px;
}
...
#review-mode-toggle-table {
    margin: 0 0 0 15px;
}
#review-mode-toggle-table svg {
    height: 16px;
    margin-top: -3px;
    width: 16px;
}
