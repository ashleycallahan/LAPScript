...
.review-mode-new-tab-link-added {
    margin:0 -26px 0 10px;
}
.review-mode-new-tab-link-added svg {
    height: 16px;
    width: 16px;
}
    ...
    window.getScreenImg = function(pageLink, url) {
        ...
        xhr.onload = function() {
            if (this.status === 200) {
                ...
                $(pageLink).parent().append('<a href="' + blobURL + '" target="_blank" class="review-mode-added-image"><img src="' + blobURL + '" alt="Thumbnail for screen: ' + $(pageLink).text().trim() + '"></a>');
            } else {}
        }
